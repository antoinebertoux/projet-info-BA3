...
- one adapted for machine with several cores, using threads (a mutex has been implemented too). It's important to allocate enough RAM for a proper functioning.
